...
class SecondScreen extends StatefulWidget {
  SecondScreen({Key key, this.title, this.total, this.colorApp})
      : super(key: key);
...
class _SecondScreenState extends State<SecondScreen> {
  ...
  Widget build(BuildContext context) {
    // can clear the state in there also, but not recommended
    // BlocProvider.of<CounterTestCubit>(context).clearValue();
    return Scaffold(
      appBar: AppBar(
